...
const withSelectProps = compose(withInputProps, withProps({required: true}));
...
const withInput = compose(withInputProps, asInput);
const withSelect = compose(withSelectProps, asSelect);
