...
class CampaignsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create campaign" do
    assert_difference('Campaign.count') do
      post campaigns_url, params: { campaign: { name: @campaign.name, owner_id: @campaign.owner_id, tagline: @campaign.tagline } }
    end
  ...
  test "should update campaign" do
    patch campaign_url(@campaign), params: { campaign: { name: @campaign.name, owner_id: @campaign.owner_id, tagline: @campaign.tagline } }
